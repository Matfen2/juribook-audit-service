# ═══════════════════════════════════════════════════════════
#  Dockerfile - juribook-audit-service (production)
...
# Définition des options JVM pour limiter l'utilisation de la mémoire à 75% de la mémoire disponible du conteneur
...
# Lancement de l'application avec les options JVM définies 
